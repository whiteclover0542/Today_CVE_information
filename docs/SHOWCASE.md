...
CWE 태그를 누르면 그 취약점 유형이 왜 생기는지 근거 문장이 바로 펼쳐집니다(지어내지 않고 CWE 공식 정의를 그대로 인용).

![CWE 태그 클릭 시 설명 노출](screenshots/cwe-tooltip.png)
...
> 전체 방법론·사례 분석은 [`AI_EVAL_REPORT.md`](AI_EVAL_REPORT.md)에, 도구 사용법은 [`scripts/eval/README.md`](../scripts/eval/README.md)에 있습니다. ✅ 목표 달성
